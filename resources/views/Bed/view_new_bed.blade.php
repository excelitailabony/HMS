                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('newbed.add') }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Enter Bed Type" name="bed">
                                        </div>
                                    </div>
                                    <div class="row">
                                            <div class="col-md-12">
                                                    <label> Bed Type</label>
                                                    <select name="bed_type_id"  required="" id="bed_type_id" class="form-control" aria-invalid="false">
                                                        <option value="" selected="" disabled="" >Select Bed Type</option>
                                                        @foreach($newbedtypes as $newbedtype)
                                                        <option value="{{ $newbedtype->id }}">{{ $newbedtype->bed_types }}</option>
                                                        @endforeach                             
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label> Bed </label>
                                                <input type="text" class="form-control"
                                                    placeholder="Enter Bed Type" name="bed" id="bed">
                                            </div>
                                            <div class="col-md-6">
                                                <label> Charge </label>
                                                <input type="text" class="form-control"
