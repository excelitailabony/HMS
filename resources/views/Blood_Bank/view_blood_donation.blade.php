                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="exampleModalLabel">New Blood Donation
                                                                            </h5>
                                                                        ...
                                                                        <form action="{{ route('blooddonation.add') }}"
                                                            ...
                                                            <div class="modal fade" id="editModal" tabindex="-1"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="exampleModalLabel">Edit Blood Donation
                                                                            </h5>
                                                                            <button type="button" class="btn-close"
                                                                                data-bs-dismiss="modal"
                                                                                aria-label="Close"></button>
                                                                        ...
                                                                        <form action="{{ route('blooddonation.update') }}"
                                                                            method="POST" enctype="multipart/form-data">
                                                                            @csrf

                                                                            <input type="hidden" id="blooddonation_id"
                                                                                name="blooddonation_id">
                                                                                ...
                                                                                @foreach ($blooddonations as $blooddonation)
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="dtr-control sorting_1"
                                                                                            tabindex="0">
                                                                                            {{ $blooddonation['donor']['name'] }}
                                                                                        </td>
                                                                                        <td>{{ $blooddonation->bags }}
                                                                                        </td>

                                                                                        <td>

                                                                                            <button type="button"
                                                                                                value="{{ $blooddonation->id }}"
