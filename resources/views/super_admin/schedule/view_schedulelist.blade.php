...
@section('css')
    ...
    <<<<<<< HEAD <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js"></script> <style>
        .topBar {
        margin-top: 4rem;
        }
        =======
        ...
        <style>
            ...
            >>>>>>>1c986b723512bdcbc1963829eb418669bcfb10df .topBar {
                padding: 2rem;
            }
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="modal fade bd-example-modal-lg" id="AddEmployeeModal"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select style='width: 200px;'
                                                            class="slot_id selUser available_days">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <span id="error_available_perpatienttime"
                                                            class="errorColor"></span>
                                                    </div>
                                                </div>
                            ...
                            <<<<<<< HEAD {{-- view --}} <div id="datatable-buttons_wrapper"
                                class="dataTables_wrapper dt-bootstrap4 no-footer">
                                =======
                                {{-- view --}}
                                <div id="datatable-buttons_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                    >>>>>>> 1c986b723512bdcbc1963829eb418669bcfb10df
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table id="datatable-buttons"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        <th class="sorting_asc" tabindex="0"
                                                            ...
                                                            aria-label="Name: activate to sort column descending">Slot Name
                                                        </th>
                                                        <th class="sorting_asc" tabindex="0"
                                                            aria-controls="datatable-buttons" rowspan="1" colspan="1"
                                                            style="width: 120px;" aria-sort="ascending"
                                                            ...
                                                            Time</th>
                                                        <<<<<<< HEAD <th class="sorting_asc" tabindex="0"
                                                            aria-controls="datatable-buttons" rowspan="1" colspan="1"
                                                            style="width: 120px;" aria-sort="ascending"
                                                            aria-label="Name: activate to sort column descending">Available
                                                            Days
                                                            </th>
                                                            <th class="sorting_asc" tabindex="0"
                                                                aria-controls="datatable-buttons" rowspan="1" colspan="1"
                                                            ...
                                                            <th class="sorting_asc" tabindex="0"
                                                                aria-controls="datatable-buttons" rowspan="1" colspan="1"
                                                                style="width: 120px;" aria-sort="ascending"
                                                                aria-label="Name: activate to sort column descending">Per
                                                                Patient Time
                                                            </th>
                                                            <th class="sorting_asc" tabindex="0"
                                                                aria-controls="datatable-buttons" rowspan="1" colspan="1"
                                                                style="width: 120px;" aria-sort="ascending"
                                                                aria-label="Name: activate to sort column descending">Serial
                                                                Visibility
                                                            </th>
                                                            <th class="sorting_asc" tabindex="0"
                                                                aria-controls="datatable-buttons" rowspan="1" colspan="1"
                                                            ...
                                                            <th class="sorting_asc" tabindex="0"
                                                                aria-controls="datatable-buttons"=======<th
                                                            ...
                                                            <th class="sorting_asc" tabindex="0"
                                                                ...
                                                                style="width: 120px;" aria-sort="ascending"
                                                                aria-label="Name: activate to sort column descending">
                                                                Available Time Start</th>
                                                            <th class="sorting_asc" tabindex="0"
                                                                aria-controls="datatable-buttons" rowspan="1" colspan="1"
                                                                style="width: 120px;" aria-sort="ascending"
                                                                aria-label="Name: activate to sort column descending">
                                                                Available Time End</th>
                                                            <th class="sorting_asc" tabindex="0"
                                                                aria-controls="datatable-buttons" rowspan="1" colspan="1"
                                                                style="width: 120px;" aria-sort="ascending"
                                                                aria-label="Name: activate to sort column descending">Per
                                                ...
                                                <tbody>
                                                    @foreach ($diagnosiscats as $diagnosiscat)
                                                        <tr>
                                                            <<<<<<< HEAD <td class="dtr-control sorting_1" tabindex="0">
                                            ...
                                            <form action="">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Slot Name<span class="errorColor">
                                                                        *</span></label>
                                                                <select style='width: 200px;' id="slot_id"
                                                                    id="selUserEdit1">
                                                                    <option value="" selected="" disabled="">Select Slot
                                                                        Name
                                                                    </option>
                                                                    @foreach ($slotsnames as $slotsname)
                                                                        <option value="{{ $slotsname->id }}">
                                                                ...
                                                                <span id="error_slot_slotidedit"
                                                                    class="errorColor"></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Doctor Name<span class="errorColor">
                                                                        *</span></label>
                                                                <select style='width: 200px;' id="doctor_id"
                                                                    id="selUserEdit2">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Available Days<span class="errorColor">
                                                                        *</span></label>
                                                                <select style='width: 200px;' id="available_days"
                                                                    id="selUserEdit3">
                                                                ...
                                                                <span id="error_available_daysedit"
                                                                    class="errorColor"></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
    ...
    @section('scripts')
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Available Time<span class="errorColor">
                                *</span></label>
                        <input type="time" id="appt" name="appt" class="form-control available_time"
                            placeholder="Start Time">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {{-- <label>Available Time<span class="errorColor"> *</span></label> --}}
                        <br>
                        <input type="time" id="appt" name="appt" class="form-control available_times"
                            placeholder="End Time">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label>Status</label><br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input status1" type="radio" name="gender1" id="inlineRadio1" value="Active">
                    <label class="form-check-label" for="inlineRadio1">Active</label>

                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input status1" type="radio" name="gender1" id="inlineRadio2" value="InActive">
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        if (response.status == 400) {
                                            ...
                                            $('#error_doctor_name').text(response.errors
                                                .doctor_id);
                                            $('#error_available_days').text(response.errors
                                                .available_days);
                                            $('#error_available_starttime').text(response.errors
                                                .available_starttime);
                                            $('#error_available_endtime').text(response.errors
                                                .available_endtime);
                                            $('#error_available_perpatienttime').text(response
                                                .errors.per_patient_time);
                                            $('#error_serialvisibility').text(response.errors
                                                .available_days);
                            ...
                            $(document).on('click', '.editBtn', function() {
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        $('#available_days').val(response.diagnosiscat
                                            .available_days);
                                        $('.available_time').val(response.diagnosiscat
                                            .available_time_start);
                                        $('.available_times').val(response.diagnosiscat
                                            .available_time_end);
                                        $('#per_patient_time').val(response.diagnosiscat
                                            .per_patient_time);
                                        $('#serial_visiability').val(response.diagnosiscat
                                            .serial_visiability);
                                        if (response.diagnosiscat.status == 'Active') {
                                            $('#editModal').find(
                                                    ':radio[name=gender1][value="Active"]')
                                                .prop(
                                                    'checked', true);
                                        } else {
                                            $('#editModal').find(
                                                    ':radio[name=gender1][value="InActive"]')
                                                .prop(
                                                    'checked', true);
                                        }
                                    }
                            ...
                            $(document).on('click', '.update_schedule_slot', function(e) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        if (response.status == 400) {
                                            $('#error_slot_slotidedit').text(response.errors
                                                .slot_id);
                                            $('#error_doctor_nameedit').text(response.errors
                                                .doctor_id);
                                            $('#error_available_daysedit').text(response.errors
                                                .available_days);
                                            $('#error_available_starttimeedit').text(response
                                                .errors.available_starttime);
                                            $('#error_available_endtimeedit').text(response
                                                .errors.available_endtime);
                                            $('#error_available_perpatienttimeedit').text(
                                                response.errors.per_patient_time);
                                            $('#error_serialvisibilityedit').text(response
