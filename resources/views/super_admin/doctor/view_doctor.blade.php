                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        <span id="error_profileedit" class="errorColor"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        <span id="error_doc_deptedit" class="errorColor"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Social Link</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Enter doctor social link" name="social_link" id="social_link">
                                                        <span id="error_sociallinkedit" class="errorColor"></span>
    ...
    {{-- <script>
        $(document).ready(function() {
            $(document).on('click', '.editBtn', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/doctor/edit-doctor/" + patient_id,
                    success: function(response) {
                        ...
                        $('#profile').val(response.patient.profile);
                        $('#doc_dept').val(response.patient.doc_dept);
                        $('#social_link').val(response.patient.social_link);
               ...
               url: "/doctor/store",
                ...
                success: function(response) {
                  if (response.status == 400) 
                  {
                    ...
                    $('#error_sociallink').text(response.errors.sociallink);
             ...
             $.ajax({
                ...
                success: function(response) {
                  if (response.status == 400) 
                  {
                    ...
                    $('#error_profileedit').text(response.errors.profile);
                    $('#error_doc_deptedit').text(response.errors.doc_dept);
                    $('#error_sociallinkedit').text(response.errors.sociallink);
                  }
                  else if(response.status ==200)
                  {
